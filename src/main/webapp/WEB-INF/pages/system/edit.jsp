<%-- 
    Document   : Edit
    Created on : Mar 9, 2016, 12:30:00 PM
    Author     : kiwi
--%>
...
<t:systempage>
    ...
    <div class="margintop20">
        <h4>Редактировать статью в категории "${cat_name}"</h4>
        <ol class="breadcrumb">
            <li class="active">
	...
	<form action="${Constants.URL}system/do/editdata" name="addArticleForm" id="addForm" method="POST" type="multipart/form-data">
            ...
            <div class="row add-row">
                ...
                <div class="col-lg-6 margintop10 field titles">
                    <input type="text" name="titleRU" class="form-control input-title-lang" lang="titleRU" id="tltRU" value="${article.article_title_ru}" maxlength="55">
                            ...
                            <div class="img-content">
                                ...
                                <c:forEach items="${images}" var="item">
                                    <div class="gallery-item">
                                        <img class="remove-icon" src="${Constants.URL}img/remove.png">
                                        <img class="main-img" src="${Constants.URL}${item.image_url}" realpath="${item.image_url}" alt="${item.image_url}">
                                        <input type="text" name="text" placeholder="Текст на русском" class="form-control galtextRU" value="${item.image_title_ru}">
                                        <input type="text" name="text" placeholder="Текст на английском" class="form-control galtextEN" value="${item.image_title_en}">
                                    </div>
                                </c:forEach>
                            </div>
            ...
            <div class="row add-row">
                ...
                <div class="col-lg-12 margintop10 field textareas">
                    <div class="ck-data-box" id="CKdata"></div>
                        <div lang="textRU" class="textarea-msg"><textarea name="textRU" id="editorRU" rows="20" cols="80" class="input-block-level">${article.article_text_ru}</textarea></div>
        ...
        <p>
            <button class="btn btn-success margintop30 marginbottom30 sudmitData" type="submit">Сохранить</button>
...
<script> 
    $(document).ready(function () {
        ...
        $("#datepicker").val("${article.article_date}");
        $( "#datepicker-act" ).datepicker();
        $( "#datepicker-act" ).datepicker("option", "dateFormat", "dd.mm.yy");
        $("#datepicker-act").val("${article.article_date_end}");
        initRemove();
        initCKE();
    });
